...
bulletImage.src = './Crowbar.png'; // Replace with your bullet image path

const enemyImage = new Image();
enemyImage.src = 'Headcrab.png'; // Replace with your enemy image path
const killSound = new Audio('./kill.mp3'); // replace with your sound file path
// Track image loading
let imagesLoaded = 0;
bulletImage.onload = () => {
    imagesLoaded++;
...
document.addEventListener('keydown', (e) => {
    ...
    if (e.key === ' ') {
        player.bullets.push({
            x: player.x + player.width / 2 - 10, // centered, considering new size
            y: player.y,
