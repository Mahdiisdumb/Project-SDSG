...
function movePlayer1() {
  ...
  if (keys["ArrowDown"] && player1Pos.y < gamearea.clientHeight - player1.offsetHeight) {
    player1Pos.y += speed;
  }
  if (keys["ArrowLeft"] && player1Pos.x > 0) {
    player1Pos.x -= speed;
  }
  if (keys["ArrowRight"] && player1Pos.x < gamearea.clientWidth - player1.offsetWidth) {
    player1Pos.x += speed;
  }
...
function movePlayer2() {
  ...
  if (keys["s"] && player2Pos.y < gamearea.clientHeight - player2.offsetHeight) {
    player2Pos.y += speed;
  }
  if (keys["a"] && player2Pos.x > 0) {
    player2Pos.x -= speed;
  }
  if (keys["d"] && player2Pos.x < gamearea.clientWidth - player2.offsetWidth) {
    player2Pos.x += speed;
  }
